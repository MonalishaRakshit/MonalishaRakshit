...
`React.js` `Node.js` `Express.js` `MongoDB` `Axios` `ImageKit`
...
- 📄 Resume upload
- 🎯 Interview practice
- 💼 Job-readiness focused features
- 🌐 Full-stack web application

### 🛠️ Tech Stack

`JavaScript` `React.js` `Node.js` `Express.js` `MongoDB` `AI`
...
- 🎵 Music-related backend functionality
...
A backend application created to strengthen my understanding of server-side development and backend application logic.
